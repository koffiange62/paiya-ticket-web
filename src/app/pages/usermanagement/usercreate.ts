    ...
    template: `<div class="card">
        ...
        <div class="grid grid-cols-12 gap-4">
            ...
            <div class="col-span-12 lg:col-span-10">
                <div class="grid grid-cols-12 gap-4">
                    <div class="mb-6 col-span-12 flex flex-col items-start gap-2">
                    ...
                    <div class="mb-6 col-span-12 md:col-span-6 flex flex-col items-start gap-2">
                        ...
                        <p-select inputId="country" [options]="countries" optionLabel="name" fluid [filter]="true" filterBy="name" [showClear]="true" placeholder="Select a Country">
                            <ng-template let-country #item>
                                <div class="flex items-center">
                                    <img src="/demo/images/flag/flag_placeholder.png" [class]="'mr-2 flag flag-' + country.code.toLowerCase()" style="width:18px" />
                    ...
                    <div class="mb-6 col-span-12 flex-col items-start gap-2">
