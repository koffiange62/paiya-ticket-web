            ...
            <div class="mt-4 md:mt-20">
                ...
                <div class="grid grid-cols-12 gap-4">
                    <div *ngFor="let member of teamMembers; let i = index" class="col-span-12 md:col-span-6 lg:col-span-3 p-4">
                        <div class="relative overflow-hidden" (mouseenter)="setVisibleMember(i)" (mouseleave)="setVisibleMember(i-1)">
    ...
    teamMembers = [
        {
            ...
            image: '/demo/images/block/team/team-1.png',
            socialIcons: [
                {
        ...
        },
        {
            name: 'Kristin Watson',
            role: 'UI/UX Designer',
            image: '/demo/images/block/team/team-2.png',
            socialIcons: [
                {
                    iconClass: 'pi pi-twitter',
                    additionalClasses: 'text-surface-600 dark:text-surface-200 text-xl mr-4'
        ...
        },
        {
            ...
            image: '/demo/images/block/team/team-3.png',
            socialIcons: [
                {
                    iconClass: 'pi pi-twitter',
                    additionalClasses: 'text-surface-600 dark:text-surface-200 text-xl mr-4'
        ...
        },
        {
            ...
            image: '/demo/images/block/team/team-4.png',
            socialIcons: [
                {
                    iconClass: 'pi pi-twitter',
                    additionalClasses: 'text-surface-600 dark:text-surface-200 text-xl mr-4'
