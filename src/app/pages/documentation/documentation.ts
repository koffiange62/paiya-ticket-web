...
@Component({
    ...
    template: `
        <div class="card">
            ...
            <p class="text-lg mb-6">Verona is an application template for Angular and is distributed as a CLI project. Current versions is Angular v20 with PrimeNG v20. In case CLI is not installed already, use the command below to set it up.</p>
            <pre class="app-code">
...
ng serve</code></pre>
            ...
            <p class="text-lg mb-6">The application should run at <i class="bg-highlight px-2 py-1 rounded-border not-italic text-base">http://localhost:4200/</i> to view the application in your local environment.</p>
            ...
            <p class="text-lg mb-6">
                Main menu is defined at <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">src/app/layout/components/app.menu.ts</span> file. Update the
